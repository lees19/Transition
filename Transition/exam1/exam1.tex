...
\begin{enumerate}
    ...
    \begin{gather*}
        S = \{z\in \RR : \exists j, k\in \ZZ \,\ s.t.\,\ z = 43j+18k\}
    \end{gather*}
    \item 
    Case $S \subseteq \ZZ$\\
    Let $x$ be an arbitrary element of $S$. Since $x\in S$, $x$ is some real number 
    of the form $43j + 18k$ for some integers $j, k \in \ZZ$ such that $x = 43j + 18k$.
